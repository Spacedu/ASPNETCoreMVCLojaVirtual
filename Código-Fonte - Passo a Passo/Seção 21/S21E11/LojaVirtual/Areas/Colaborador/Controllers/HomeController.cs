...
namespace LojaVirtual.Areas.Colaborador.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public IActionResult Recuperar([FromForm]Models.Cliente cliente)
        {
            ...
            {
                var colaboradorDoBancoDados = _repositoryColaborador.ObterColaboradorPorEmail(cliente.Email);

                if (colaboradorDoBancoDados != null)
                {
        ...
        public IActionResult CriarSenha([FromForm]Models.Cliente cliente, string id)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (colaboradorDB != null)
                {
                    colaboradorDB.Senha = cliente.Senha;

                    _repositoryColaborador.Atualizar(colaboradorDB);
