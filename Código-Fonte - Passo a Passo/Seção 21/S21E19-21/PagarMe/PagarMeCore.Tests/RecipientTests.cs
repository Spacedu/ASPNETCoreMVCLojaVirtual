...
namespace PagarMeCore.Tests
{
	...
	public class RecipientTests : PagarMeTestFixture
	{
        ...
        public void CreateAnticipation()
        {
            ...
            Assert.IsTrue(anticipation.Status == PagarMe.Enumeration.BulkAnticipationStatus.Pending);               
        }
        ...
        public void CancelAnticipation()
        {
            ...
            Assert.IsTrue(anticipation.Status == PagarMe.Enumeration.BulkAnticipationStatus.Canceled);
        }
