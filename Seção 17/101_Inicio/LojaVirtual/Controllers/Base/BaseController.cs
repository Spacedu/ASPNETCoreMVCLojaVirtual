...
namespace LojaVirtual.Controllers.Base
{
    public class BaseController : Controller
    {
        ...
        public BaseController(CookieCarrinhoCompra carrinhoCompra, IEnderecoEntregaRepository enderecoEntregaRepository, IProdutoRepository produtoRepository, IMapper mapper, WSCorreiosCalcularFrete wscorreios, CalcularPacote calcularPacote, CookieFrete cookieFrete)
        {
