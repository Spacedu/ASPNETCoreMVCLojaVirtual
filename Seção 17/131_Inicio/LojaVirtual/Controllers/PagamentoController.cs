        ...
        public IActionResult Index([FromForm]IndexViewModel indexViewModel)
        {
            if(ModelState.IsValid)
            {
                ...
                try
                {
                    ...
                    pedido.FormaPagamento = (transaction.PaymentMethod == 0) ? "Cartão de Crédito" : "Boleto";
                    pedido.ValorTotal = ObterValorTotalCompra(produtos);
                    pedido.DadosTransaction = transaction; // TODO - Serializar;
                    pedido.DadosProdutos = produtos; // TODO - Serializar;
                    pedido.DataRegistro = DateTime.Now;
                    pedido.Situacao =  "";//TODO - Situacao - Criar Constants.

                    _pedidoRepository.Cadastrar(pedido);
                    //TODO - Salvar Pedido Situação.
